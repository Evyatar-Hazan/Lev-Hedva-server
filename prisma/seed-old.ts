...
async function main() {
  ...
  // Give worker basic permissions
  const workerPermissions = ['users.read', 'products.read', 'products.write', 'loans.read', 'loans.write'];
  ...
  const volunteerPermissions = ['products.read', 'volunteers.read', 'volunteers.write'];
